...
================================
1. Go to backend directory in your command prompt in main.py directory
...
3. Ngork needs to signup for free. After that you can run this.
4. Open windows command prompt, go to that folder and run this command: ngrok http 80000
